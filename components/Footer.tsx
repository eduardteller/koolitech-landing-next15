const Footer = () => {
  return (
    <footer className="flex w-full flex-col items-start justify-between border-t px-8 pb-8 pt-24 text-slate-900">
      <div className="container mx-auto flex max-w-screen-xl flex-row items-start justify-start pb-32">
        <div className="w-1/2">
          ...
          <ul className="text-sm text-slate-900/80">
            <li className="duration-100 hover:text-slate-900">
      ...
      <div className="container mx-auto flex max-w-screen-xl flex-col items-center justify-center px-4">
        <p className="text-sm text-zinc-400">Copyright © 2024 KooliTech OÜ</p>
      </div>
    </footer>
  );
};
